...
#define Q_QUEUE_LEN    12
#define Q_MESSAGE_LEN  96
#define TECH_INFO  7   						// 1 address byte, 1 index byte, 1 command number byte, ..... 4 CRC bytes
#define MESSAGE_LEN  ( Q_MESSAGE_LEN - TECH_INFO )   // usefull data length
...
#define GET_FULL_MESSAGE_INDEX(CurrentInd, TotalNumInd) ( ((CurrentInd) << 4) | (TotalNumInd) )

// used in both uarts
#define PAUSE_AFTER_TRANSMIT   				4000	//10000	//2000
#define PAUSE_AFTER_TRANSMIT_SKIP   		5
#define PAUSE_AFTER_TRANSMIT_MINIMUM 		400
#define PAUSE_AFTER_TRANSMIT_TO_MODEM   	50


#define HOST_ADDRESS 0
#define NODE1_ADDRESS 1
#define THIS_DEVICE_ADDRESS 2
#define MODEM_ADDRESS 3

#define CONFIRMATION_FLAG_TO_NODE1  0x01
...
struct QUEUE_MANAGER {
	...
	struct waitForConfirmation fromNode1;
...
// * * * * * * * * * * * * * * * *
//  ( now maximum Answer length is of 24 bytes. It is E220_900T30D_ANSW_ADC_GET_DATA answer. )
...
/*struct debug01 {
	...
	uint32_t e220_Sistick_;
	uint32_t e220_Sistick_pauseAfterTransmit;
