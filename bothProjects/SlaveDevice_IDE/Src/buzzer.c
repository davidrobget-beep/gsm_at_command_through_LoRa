...
const struct noise_types noiseTypes[BUZZER_NOISE_LENGTH] = {
	 ...
	 {.type = BUZZER_NOISE_TYPE_SINGLE, .period = 170, .pause = 100 },	// BUZZER_NOISE_SINGLE_170_100
	 {.type = BUZZER_NOISE_TYPE_SINGLE, .period = 300, .pause = 100 },	// BUZZER_NOISE_SINGLE_300_100
	 {.type = BUZZER_NOISE_TYPE_REPEAT, .period = 400, .pause = 350 },	// BUZZER_NOISE_REPEAT_400_350
	 {.type = BUZZER_NOISE_TYPE_SINGLE, .period = 600, .pause = 500 },	// BUZZER_NOISE_REPEAT_600_500
